var Sprite3D = Sprite3D || {
    ...
    stage: function (e) {
        ...
        if (e) {
            t = e;
            n = e.style;
            if (n.position === "assets") n.position = "relative"
        } else {
    ...
    create: function (e) {
        ...
        } else if (e.style.position == "assets") {
    ...
    _props: {
        x: function (e) {
            ...
            var t = e.toLowerCase().split(" "), n = t.length, r = 0, i = [], s = [0, 0, 0, 0, 0, 0, 0, 0, 0], o = 0;
            for (r; r < n; r++) {
                switch (t[r]) {
                    case"p":
                    case"position":
            ...
            return this
        }, tileWidth: 0, tileHeight: 0, tileSize: function (e, t) {
            this.tileWidth = e;
            this.tileHeight = t;
            return this
